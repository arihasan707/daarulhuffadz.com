<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1><?= $head . " " . $galeri->nama ?></h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('administrator/') ?>">Beranda</a></li>
                <li class="breadcrumb-item active"><?= $head . " " . $galeri->nama ?></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="col-12">
        ...
        <div class="col-12">
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong> Berhasil ! </strong> Data Folder galeri telah <?= $this->session->flashdata('success') ?>
        ...
        <div class="tambah">
            <a data-bs-toggle="modal" data-bs-target="#tambah" class="col-12 btn btn-success">Tambah Folder</a>
        </div>
        <div class="card1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><img
                                src="<?= base_url('assets/backend/upload/galeri/folder/sampul/' . $value->sampul) ?>"
                                alt="sampul_galeri" srcset="" width="250"><br>
                            <span><i class="bi bi-images"></i> <?= $value->jml_foto ?> Foto</span><br>
                            <span><a href="<?= base_url('administrator/tambah_foto_galeri/' . $value->id_folder_galeri . "/" . $galeri->id) ?>"
                                    class="btn btn-sm btn-success"> <i class="bi bi-plus"></i>Tambah
                                    Foto</a></span>
                        </td>
                        <td><a href="" data-bs-toggle="modal" data-bs-target="#edit<?= $value->galeri_id ?>"
                                class="btn btn-sm btn-primary"> <i class="bi bi-pencil"></i></a>
                            <a href="" data-bs-toggle="modal" data-bs-target="#hapus<?= $value->galeri_id ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('administrator/proses_tambah_folder_galeri/' . $galeri->id) ?>"
                    method="post" enctype="multipart/form-data">
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label bold">Nama Galeri<span>*</span></label>
                        <input type="text" name="nama_folder" class="form-control" id="exampleFormControlInput1"
...
<div class="modal fade" id="edit<?= $value->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header head">
                <h5 class="modal-title bold" id="exampleModalLabel">Edit Folder <?= $galeri->nama ?></h5>
            </div>
            <div class="modal-body">
                <form
                    action="<?php echo base_url('administrator/edit_folder_galeri/' . $value->id_folder_galeri . "/" . $value->galeri_id) ?>"
                    method="post" enctype="multipart/form-data">
                    <div class="mb-2">
                        <label for="exampleFormControlInput1" class="form-label bold">Nama Folder<span></span></label>
                        <input type="text" value="<?= $value->nama ?>" name="nama_folder" class="form-control"
                    ...
                    <div class="mb-2">
                        <div>
                            ...
                            <div>
                                <img src="<?= base_url('assets/backend/upload/galeri/folder/sampul/' . $value->sampul) ?>"
                                    width="250">
                            </div>
                        </div>
                    </div>
