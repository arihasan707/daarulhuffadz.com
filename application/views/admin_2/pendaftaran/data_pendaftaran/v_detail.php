                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><a
                                            href="<?= base_url('admin_satu/download_foto/' . $d->id_pendaftaran) ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><a
                                            href="<?= base_url('admin_satu/download_ktp/' . $d->id_pendaftaran) ?>"
                                            class="btn btn-primary">Klik Unduh</a></div>
                                    <?php } ?>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><a
                                            href="<?= base_url('admin_satu/download_ijazah/' . $d->id_pendaftaran) ?>"
                                            class="btn btn-primary">Klik Unduh</a></div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><a
                                            href="<?= base_url('admin_satu/download_ngaji/' . $d->id_pendaftaran) ?>"
                                            class="btn btn-primary">Klik Unduh</a></div>
                                </div>
