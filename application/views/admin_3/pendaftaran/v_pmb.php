                ...
                <tbody>
                    ...
                    foreach ($pmb as $s) : ?>
                        <tr>
                            ...
                            <td class="bold">
                                <?= highlight_phrase($s->nama_kelas, "(", "<br> <span style='font-weight:400;'>") ?>
                            </td>
                            <td><?= $s->nama ?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    if ($s->status == '0') {
                                        ...
                                        echo "<a href=" . base_url('admin_tiga/detail_pmb/' . $s->id_pmb_po) . " 
                                    ...
                                    class='btn btn-success btn-sm'><i class='bi bi-whatsapp'></i></a>";
                                        echo "<a id='hapus_po' data-id='$s->id_pmb_po' class='btn btn-danger btn-sm'><i class='bi bi-trash3-fill'></i></a>";
                                    }
                                    ?>
                                </div>
                            </td>
